...
},{"./components/Provider":"node_modules/react-redux/es/components/Provider.js","./components/connectAdvanced":"node_modules/react-redux/es/components/connectAdvanced.js","./connect/connect":"node_modules/react-redux/es/connect/connect.js"}],"main.js":[function(require,module,exports) {
'use strict';
...
var Cell = function Cell(props) {
  return _react2.default.createElement('div', {
    ...
    onClick: function onClick() {
      return props.onCellClick(props.x, props.y);
    }
  });
};

var CellContainer = (0, _reactRedux.connect)(function (state, ownProps) {
  return {
  ...
  return {
    onCellClick: function onCellClick(x, y) {
      dispatch({ type: 'ON_CELL_CLICK', data: { x: x, y: y } });
    }
  };
})(Cell);
...
var Row = function Row(props) {
  return Array(n).fill().map(function (_, i) {
    return _react2.default.createElement(CellContainer, { y: props.y, x: i, key: i });
  });
};
...
var Table = function Table(props) {
  return Array(n).fill().map(function (_, i) {
    return _react2.default.createElement(
      'div',
      { key: i },
      _react2.default.createElement(Row, { y: i })
    );
  });
};

var store = (0, _redux.createStore)(function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { x: 1, y: 1 };
  var action = arguments[1];
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","redux":"node_modules/redux/es/redux.js","react-redux":"node_modules/react-redux/es/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.7601e209.map